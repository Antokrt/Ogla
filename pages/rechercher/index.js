    ...
    if(err){
        return(
            <div className={styles.containerErr}>
                ...
                <ErrMsg click={() => router.back()}  text={"Impossible d'effectuer la recherche, veuillez réessayer..."} />
                    ...
                    <div className={styles.containerM}>
                        <div className={styles.containerCardPreview}>
                            <div className={styles.sortContainer}>
                                <h3 onClick={() => searchNewBooks()}>Résultat pour : {ReduceString(Capitalize(activeQuery),50)}</h3>
                                <div>
                                    <button
                                        onClick={() => {
                                            setFilter('popular');
