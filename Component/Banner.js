    ...
    return (
        <div className={styles.container}>
            <div className={styles.HomeCenterBlock}>
                ...
                <img className={styles.welcomeDesktop} src={assets + 'diapo/Welcome.png'} onError={(e) =>e.target.src = '/assets/diapo/Welcome.png'}/>
            </div>
            <img className={styles.mountain} src={assets+ 'diapo/mountain2.png'} onError={(e) =>e.target.src = '/assets/diapo/mountain2.png'}/>
