    ...
    return (
        <div className={styles.container}>
            <div className={styles.HomeCenterBlock}>
                ...
                <img alt={'Welcome Image Ogla'} className={styles.welcomeDesktop} src={assets + 'diapo/Welcome.png'} onError={(e) =>e.target.src = '/assets/diapo/Welcome.png'}/>
            </div>
            <img alt={'Mountain Image Ogla'} className={styles.mountain} src={assets+ 'diapo/mountain2.png'} onError={(e) =>e.target.src = '/assets/diapo/mountain2.png'}/>
